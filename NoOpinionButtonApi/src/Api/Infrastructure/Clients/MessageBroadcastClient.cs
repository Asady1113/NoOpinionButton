...
/// <summary>
/// メッセージ配信クライアント
/// WebSocket APIを使用してメッセージを参加者に配信する
/// </summary>
public class MessageBroadcastClient : IMessageBroadcastClient
{
    private readonly IWebSocketConnectionRepository _connectionRepository;

    public MessageBroadcastClient(IWebSocketConnectionRepository connectionRepository)
    {
    ...
    public async Task<bool> BroadcastMessageAsync(string meetingId, Message message)
    {
        // 会議の有効な接続を取得
